...
class _TVPageState extends State<TVPage>{
  List timeRow = ["00:00", "00:57", "01:00", "02:45", "03:00", "03:34", "04:00", "05:00", "05:55", "06:00", "06:15", "06:59", "07:00", "07:29", 
  ...
  List dayCol = ["Monday", "Tuesday ", "Wednesday ", "Thursday", "Friday", "Saturday", "Sunday"];
  List televisionData = [
...
determineTVColor(String tvString, [bool stickyBar = false, bool keyCell = false, bool time=false]){
  ...
  else if(time==true&&DateTime.now().hour==int.parse(tvString.substring(0,2))&&DateTime.now().minute>=int.parse(tvString.substring(3,4)))
    return Color(0xFFFF511C).withOpacity(0.4);
  else if(stickyBar&&!keyCell)
    return colorSelectedAccent.withOpacity(0.5);
  else if(keyCell)
