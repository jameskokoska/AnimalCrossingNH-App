...
class _FishListPageState extends State<FishList>{
  ...
  void initState(){
    super.initState();
    futureFish=getFishData(searchFish);
  }
                        ...
                        child: new Container(
                          child: new Material(
                            child: new InkWell(
                              ...
                              onLongPress: (){
                                setState(() {
                                  currentCaughtFish = !snapshot.data;
                                  saveBool("fishCheckList"+name, false, !snapshot.data);
                                });
                              },
                              onTap: (){
                                currentCaughtFish = snapshot.data;
                                ...
                                future.then((void value)=> setState(() {
                                  saveBool("fishCheckList"+name, false, currentCaughtFish);
                                }));
                              },
                              child: new Container(
                                ...
                                child: new Checkbox(
                                  ...
                                  onChanged: (bool value) {
                                    setState(() {
                                      ...
                                      saveBool("fishCheckList"+name, false, value);
